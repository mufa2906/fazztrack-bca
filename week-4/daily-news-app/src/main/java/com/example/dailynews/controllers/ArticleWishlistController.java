...
public class ArticleWishlistController {
  ...
  @PostMapping
  public ResponseEntity<?> createArticleComment(@RequestBody @Valid AddArticleWishlistRequest request) {
  ...
  @GetMapping("/{userId}")
  public ResponseEntity<?> getArticleCommentsByArticle(@PathVariable String userId) {
